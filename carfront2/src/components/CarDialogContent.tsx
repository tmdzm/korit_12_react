...
export default function CarDialogContent({car, handleChange} : DialogFormProps) {
  return(
    <>
      <DialogContent>
          <TextField type="text" placeholder="브랜드" name='brand' value={car.brand} onChange={handleChange}/><br />
          <TextField type="text" placeholder="모델" name='model' value={car.model} onChange={handleChange}/><br />
          ...
          <TextField type="number" placeholder="제작년도" name='modelYear' value={car.modelYear} onChange={handleChange}/><br />
